...
public class Watches2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Have you scanned the QR code? Please enter 1 for yes or 2 for no.");
		qr = scan.nextInt();
	    while(qr != yes){
	        System.out.println("Please scan the QR code, sanitise your hand and check your temperature.");
	        System.out.println("Have you scanned the QR code? Please enter 1 for yes or 2 for no.");
	    ...
	    sanitise = scan.nextInt();
		    while(sanitise != yes) {
			System.out.println("Please scan the QR code, sanitise your hand and check your temperature.");
			System.out.println("Have you sanitised your hands? Please enter 1 for yes or 2 for no.");
		    sanitise = scan.nextInt();
		    }
		    System.out.println("Thank you.");
		    System.out.println();
		    System.out.println("Have you checked your temperature ? Please enter 1 for yes or 2 for no.");
		    check = scan.nextInt();
		        while(check != yes) {
		    	System.out.println("Please scan the QR code, sanitise your hand and check your temperature.");
		    	System.out.println("Have you checked your temperature ? Please enter 1 for yes or 2 for no.");
	...
	public static void Pogram(String pogram) {
...
//PART 1		
	...
	System.out.println("Activity level : \r\n"
			...
			+ "        1.375, for lightly active (light exercise 1–3 days per week)\r\n"
			+ "	1.55, for moderately active (moderate exercise 3–5 days per week)\r\n"
			+ "	1.725, for very active (hard exercise 6–7 days per week)\r\n"
			+ "	1.9, for extra active (very hard exercise, training, or a physical job)");
...
//PART 2
	...
	//TotalDailyEnergyExpenditure(TDEE)
        ...
        System.out.println( name + ", your RestingMetaboliCRate (RMR) is " + rmr + "kcal/day.");
        System.out.println( name + ", your TotalDailyEnergyExpenditure (TDEE) is " + tdee + " kccal/day.");
...
//PART 3
        ...
        if (lose == 1)
        	...
        	System.out.println("You are maintain weight. You should have " + tdee +" kcal/day.");
        else if(lose == 3)
