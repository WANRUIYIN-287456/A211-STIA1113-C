...
public class Lifestyle {
	...
	public static void main(String[] args) {
		...
		System.out.println("Good day! Please input '1' to proceed.");   
		...
		while (conService == 1) {  
		 ...
		 System.out.println("Are you interested in continue with other shops? Please input '1' to continue and any other integer to direct to payment.");
		 conService = scan.nextInt();
}
// PAYMENT
		...
		if(x[i] ==1)
		System.out.println("Upgrading Pogram                 *1       ");
		if(x[i] ==2)
		System.out.println("Shoe Package                     *1       ");
		if(x[i] ==3)
		System.out.println("Handbag                          *1       ");
		if(x[i] ==4)
		System.out.println("Garden Ticket Package            *1       ");
		if(x[i] ==5)
		System.out.println("Camera                           *1       ");
		if(x[i] ==6)
		System.out.println("Clothes Package                  *1       ");
		if(x[i] ==7)
		System.out.println("Interior Design Package          *1       ");
		}
		System.out.println();
		System.out.println();
...
//1. INPUT USER DETAILS and MAIN PROGRAM
	
	public static void Program(int program) {
		//PART 1		
			//INPUT USER DETAILS
			Scanner scan = new Scanner (System.in);	
