...
public class WatchesAssignment2 {
...
//PART 4	
	...
	System.out.println("Please enter the distance travelled today in metres.");
	...
	System.out.println("Please enter 1 to register for our member and 2 if not to become a member.");
	member = scan.nextInt();
	if(member == 1) {
	price = 160*0.8;
	discount = 160*0.2;
